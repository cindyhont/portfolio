...
const 
    ...
    Modal = (
        ...
        const modalOnClick = (e:ChangeEvent<HTMLInputElement>) => {
            const 
            ...
            document.getElementById('aurora-container').dispatchEvent(new CustomEvent('modal',{detail:checked}))
        }

        return (
            <div key={slug}>
                <input className="modal-input" id={slug} type="checkbox" onChange={modalOnClick} />
