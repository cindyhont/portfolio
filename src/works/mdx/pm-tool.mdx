...
order: 0
backgroundColor: '#000'
stack: [Next.js, Redux Toolkit, Golang, Websocket, REST API, PostgreSQL, Nginx, Canvas, Material UI]
---
<p>Built by me from scratch and hosted on multiple servers at Oracle Cloud.</p>
<p>
